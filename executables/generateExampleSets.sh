...
python generateFuzzySet.py $appendToFile -n 20 --triangularRescaled -rescaleX 2.0 -comment "Small triangular set and same set resized by 2 in x scale"

python generateFuzzySet.py $appendToFile -n 200 --triangularRescaled -rescaleX 2.0 -comment "Large triangular set and same set resized by 2 in x scale"

python generateFuzzySet.py $appendToFile -n 20 --triangularRescaled -rescaleX 2.0 -comment "Large triangular set and same set resized by 2 in x scale"

python generateFuzzySet.py $appendToFile -n 20 --triangularRescaled -rescaleY 0.5 -comment "Small triangular set and same set resized by 2 in y scale"

python generateFuzzySet.py $appendToFile -n 200 --triangularRescaled -rescaleY 0.5 -comment "Large triangular set and same set resized by 2 in y scale"

python generateFuzzySet.py $appendToFile -n 200 --triangularRescaled -rescaleY 0.5  -rescaleX 0.5 -comment "Large triangular set and same set resized by 2 in y and x scale"

python generateFuzzySet.py $appendToFile -n 200 --triangularRescaled -rescaleY 0.5  -rescaleX 2 -comment "Large triangular set and same set resized by 2 in x scale and 0.5 in y and x scale"
